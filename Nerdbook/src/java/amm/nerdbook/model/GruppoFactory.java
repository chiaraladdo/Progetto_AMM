...
public class GruppoFactory {
    ...
    private GruppoFactory() {
        ...
        gruppo1.setUrlFotoGruppo("../web/M2/img/grifondoro.jpg");
        ...
        gruppo2.setUrlFotoGruppo("../web/M2/img/tassorosso.GIF");
        ...
        gruppo3.setUrlFotoGruppo("../web/M2/img/corvonero.GIF");
        ...
        gruppo4.setUrlFotoGruppo("../web/M2/img/serpeverde.jpg");
